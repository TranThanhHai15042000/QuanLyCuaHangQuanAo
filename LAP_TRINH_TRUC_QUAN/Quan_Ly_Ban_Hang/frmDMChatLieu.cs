...
using Quan_Ly_Ban_Hang.Class; //Sử dụng class Functions.cs
...
namespace Quan_Ly_Ban_Hang
{
    public partial class frmDMChatLieu : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            tblCL = Class.DMChatLieu.GetDataToTable(sql); //Đọc dữ liệu từ bảng
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (Class.DMChatLieu.CheckKey(sql))
            {
            ...
            Class.DMChatLieu.RunSQL(sql); //Thực hiện câu lệnh sql
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn xoá không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                Class.DMChatLieu.RunSqlDel(sql);
                LoadDataGridView();
                ResetValue();
            }
        }
